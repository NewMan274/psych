  ...
  return (
    <div className=''>
      <section className="grid grid-rows-4">
        ...
        <div className='row-start-3 text-justify'>
          <p className='text-amber-100 pt-5 pl-4 pr-120 text-3xl font-mono'>
        ...
        <div className="row-start-4 flex flex-row flex-nowrap justify-center space-x-5 my-5 text-white px-4 overflow-auto">
          <div className="bg-[url(../../assets/images/newww.jpg)] opacity-60 hover:border-amber-200 rounded-full hover:border-solid p-8 text-center hover:text-2xl hover:opacity-100 hover:h-64">
          ...
          <div className="bg-[url(../../assets/images/newww.jpg)] opacity-60 hover:border-amber-200 rounded-full hover:border-solid p-9 text-center hover:text-2xl hover:opacity-100 hover:h-64">
